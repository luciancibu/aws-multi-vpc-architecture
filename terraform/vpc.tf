...
# Notes:
# module.backend_vpc.private_route_table_ids[0] -> route only for "10.2.1.0/24" this subnet.
# module.backend_vpc.private_route_table_ids[1] -> route only for "10.2.2.0/24" this subnet.
...
resource "aws_route" "backend_to_frontend" {
  route_table_id             = module.backend_vpc.private_route_table_ids[0]  # -> route only for "10.2.1.0/24" this subnet
